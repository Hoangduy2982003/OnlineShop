...
public class AccountController : Controller
{
    ...
    public IActionResult RecoveryPassword(RecoveryPasswordViewModel recoveryPassword)
    {
        ...
        mail.From = new MailAddress("luongnguyenhoangduy2982003@gmail.com");
        mail.To.Add(foundUser.Email);
        mail.Subject = "Recovery code";
        mail.Body = "your recovery code:" + foundUser.RecoveryCode;

        SmtpServer.Port = 587;
        SmtpServer.Credentials = new System.Net.NetworkCredential("luongnguyenhoangduy2982003@gmail.com", "kkeb liys zrxv fekl");
